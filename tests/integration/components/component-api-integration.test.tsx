...
describe('Component-API Integration Testing', () => {
  beforeEach(() => {
    ...
    vi.spyOn(React, 'useEffect').mockImplementation((effect, deps) => {
      // biome-ignore lint/correctness/useExhaustiveDependencies: Test mock - deps is already an array
  ...
  describe('Repository Card Integration', () => {
    it('integrates bookmark functionality with API', async () => {
      ...
      const mockBookmark = vi.fn(async (repoId: string) => {
        ...
        const url = repository.is_bookmarked ? `/api/bookmarks/${repoId}` : '/api/bookmarks'
    ...
    it('displays repository data correctly from API response', () => {
      ...
      expect(
        screen.getByRole('article', { name: 'Repository awesome-project' })
      ).toBeInTheDocument()
  ...
  describe('Opportunity Matching Integration', () => {
    it('calculates skill matches correctly with user data', () => {
      ...
      expect(
        screen.getByRole('article', { name: 'Opportunity Fix TypeScript migration' })
      ).toBeInTheDocument()
  ...
  describe('User Profile Integration', () => {
    it('fetches and displays user profile data', async () => {
      ...
      expect(
        screen.getByText('Full-stack developer passionate about open source')
      ).toBeInTheDocument()
