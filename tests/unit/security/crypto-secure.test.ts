...
describe('Cryptographically Secure Random', () => {
  ...
  describe('generateSecureId', () => {
    it('should generate unique IDs', () => {
      const ids = new Set(
        Array.from({ length: 10000 }, () => generateSecureId())
      )
    ...
    it('should include timestamp for ordering', () => {
      const ids = Array.from({ length: 100 }, () => {
        ...
        return {
          id,
          timestamp: parseInt(id.split('_')[1], 36)
        }
      })
  ...
  describe('getSecureRandomFloat', () => {
    ...
    it('should generate different values', () => {
      const values = new Set(
        Array.from({ length: 1000 }, () => getSecureRandomFloat())
      )
  ...
  describe('getSecureRandomInt', () => {
    ...
    it('should have uniform distribution for small ranges', () => {
      const min = 0
      const max = 10
      const samples = Array.from({ length: 100000 }, () => 
        getSecureRandomInt(min, max)
      )
  ...
  describe('getSecureRandomWithFallback', () => {
    ...
    afterEach(() => {
      ...
      globalThis.require = originalRequire as any
    })
