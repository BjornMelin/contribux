...
export const UserFactorySchema = z.object({
  ...
  skills_confidence: z.record(z.string(), z.number()).default({}),
  contribution_patterns: z.record(z.string(), z.any()).default({}),
  preference_weights: z.record(z.string(), z.number()).default({}),
