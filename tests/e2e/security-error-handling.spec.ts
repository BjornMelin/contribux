...
test.describe('Security Error Handling E2E Tests', () => {
  test.describe('Authentication Error Flows', () => {
    test('should handle JWT token expiration gracefully', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="session-expired-banner"]')).toContainText(/session.*expired/i)
    ...
    test('should handle OAuth provider errors', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="oauth-error"]')).toContainText(/account.*already exists/i)
  ...
  test.describe('Authorization Error Handling', () => {
    ...
    test('should handle resource ownership errors', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="ownership-error"]')).toContainText(/not authorized.*modify/i)
  ...
  test.describe('Input Validation Security', () => {
    test('should prevent XSS attempts', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="field-error-title"]')).toContainText(/malicious content/i)
  ...
  test.describe('Session Security', () => {
    test('should detect concurrent session attempts', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="other-session-location"]')).toContainText('Chrome on Windows')
