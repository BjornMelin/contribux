...
test.describe('NextAuth Complete Authentication Journey', () => {
  ...
  test.describe('Complete OAuth Flow', () => {
    ...
    test('should handle OAuth error scenarios', async ({ page }) => {
      ...
      const errorCallbackUrl = '/api/auth/callback/github?error=access_denied&error_description=User%20denied%20access'
  ...
  test.describe('Authentication State Navigation', () => {
    test('should redirect unauthenticated users from protected routes', async ({ page }) => {
      ...
      // Take screenshot
      await page.screenshot({ path: 'test-results/auth/protected-route-redirect.png', fullPage: true })
    })
