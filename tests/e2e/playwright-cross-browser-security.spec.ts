...
const currentProjectName = () => test.info().project.name || 'browser'

test.describe('Security Compliance Testing', () => {
  test('Security Headers Validation', async ({ page }) => {
    const browserName = currentProjectName()
  ...
  test('Web Crypto API Security', async ({ page }) => {
    const browserName = currentProjectName()
  ...
  test('WebAuthn API Support', async ({ page }) => {
    const browserName = currentProjectName()
  ...
  test('Cookie Security Compliance', async ({ page, context }) => {
    const browserName = currentProjectName()
  ...
  test('CSP Compliance Testing', async ({ page }) => {
    const browserName = currentProjectName()
  ...
  test('HTTPS and Secure Context', async ({ page }) => {
    const browserName = currentProjectName()
  ...
  test('Form Security Testing', async ({ page }) => {
    const browserName = currentProjectName()
  ...
  test('Browser-Specific Security Features', async ({ page }) => {
    const browserName = currentProjectName()
