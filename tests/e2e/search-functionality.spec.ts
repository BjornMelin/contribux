...
test.describe('Search and Repository Discovery', () => {
  ...
  test.describe('Search Interface Testing', () => {
    test('should render search interface correctly', async ({ page }) => {
      ...
      const searchInput = page.locator('.search-input, [aria-label="Search input"], input[type="text"]')
      const searchButton = page.locator('.search-button, [aria-label="Search"], button[type="submit"]')
  ...
  test.describe('Search Results Testing', () => {
    test('should display search results correctly', async ({ page }) => {
      ...
      const resultCards = page.locator('.opportunity-card, .repository-card, [data-testid="result-item"]')
    ...
    test('should handle empty search results', async ({ page }) => {
      ...
      // Verify empty state
      const noResultsMessage = page.locator('text=No results found, .empty-state, [data-testid="no-results"]')
      await expect(noResultsMessage).toBeVisible()
      
      // Check for helpful suggestions
      const suggestions = page.locator('.suggestions, .search-tips, [data-testid="search-suggestions"]')
    ...
    test('should handle search result pagination', async ({ page }) => {
      ...
      const prevButton = page.locator('button:has-text("Previous"), button:has-text("Prev"), [data-testid="prev-page"]')
  ...
  test.describe('Repository Discovery Testing', () => {
    ...
    test('should handle repository bookmarking', async ({ page }) => {
      ...
      const bookmarkButton = page.locator('button:has-text("Bookmark"), [data-testid="bookmark-button"]')
