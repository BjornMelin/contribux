...
**Next.js 16 + React 19 + TypeScript 5.9 + Vitest 4.1 + NextAuth.js v4 + Drizzle ORM**
...
- **Vitest 4.1+**: Fast, modern test runner with native ESM support
...
```bash
pnpm exec vitest run --config vitest.config.ts tests/unit/components
pnpm lint
pnpm type-check
```
...
- name: Run Component Tests
  run: |
    pnpm exec vitest run --config vitest.config.ts tests/unit/components --coverage --reporter=verbose
    pnpm lint
    pnpm type-check
...
**Generated by Component Testing Agent | Version 1.0 | Next.js 16 + React 19 + TypeScript 5.9**
