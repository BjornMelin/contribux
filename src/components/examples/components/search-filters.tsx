...
import type { useSearchState } from '../hooks/use-search-state'

interface SearchFiltersProps {
  searchType: 'repositories' | 'opportunities'
  filters: ReturnType<typeof useSearchState>['filters']
  setFilters: ReturnType<typeof useSearchState>['setFilters']
}
