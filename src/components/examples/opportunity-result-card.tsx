      ...
      <div className="rounded-lg border p-4 transition-colors hover:bg-gray-50">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <h3 className="font-medium text-green-600 text-lg">{opportunity.title}</h3>
            {opportunity.description && (
              <p className="mt-1 line-clamp-2 text-gray-600">{opportunity.description}</p>
            )}
            <div className="mt-2 flex items-center space-x-4 text-sm">
              ...
              <span className="text-gray-500">Impact: {opportunity.impactScore}/10</span>
              <span className="text-gray-500">Match: {opportunity.matchScore}/10</span>
            </div>
          </div>
          <button
            type="button"
