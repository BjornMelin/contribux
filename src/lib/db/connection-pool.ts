...
class MemoryOptimizedPool {
  ...
  constructor(config: Partial<PoolConfig> = {}) {
    console.warn('⚠️  DEPRECATED: Custom connection pool is deprecated. Use Neon\'s built-in PgBouncer pooling instead.')
    console.warn('📖 Migration guide: Check src/lib/db/connection-pool.ts for migration instructions.')
